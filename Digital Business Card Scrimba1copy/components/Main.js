...
export default function Main() {
    return (
        <main className="main1">
            <h1 className="main--title">Muonyelu Chinedu</h1>
            <h3 className="h31" >Frontend Developer</h3>
            <h5>muonyelu@chinedu.com</h5>
            <div className="btn">
                <button className="btn1"><svg xmlns="http://www.w3.org/2000/svg" width="17" height="16" viewBox="0 0 17 16" fill="none">
                ...
                <button className="btn2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
